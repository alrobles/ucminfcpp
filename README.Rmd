...
algorithm. It is a **drop-in replacement** for `ucminf::ucminf()` and was
...
guides (C++, Python, Julia), visit the
[`ucminfcpp` documentation site](https://alrobles.github.io/ucminfcpp/).
