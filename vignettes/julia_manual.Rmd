---
title: "Using ucminfcpp from Julia"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Using ucminfcpp from Julia}
...
optimizer core directly from Julia code, achieving performance on par with
native Julia optimization libraries.
...
- CMake ≥ 3.15
- [`CxxWrap.jl`](https://github.com/JuliaInterop/CxxWrap.jl) Julia package
